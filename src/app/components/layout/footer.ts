      ...
      <div class="mission-footer-container">
        <div class="mission-footer-bottom">
          ...
          <div class="mission-footer-links">
            <a href="https://github.com/r-spacex/SpaceX-API" target="_blank" class="mission-footer-link">API Documentation</a>
            <a routerLink="/status" class="mission-footer-link flex items-center gap-2">
              <span [class]="'w-2 h-2 rounded-full ' + 
                (launchpadsService.apiStatus() === ApiStatus.ONLINE ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 
                launchpadsService.apiStatus() === ApiStatus.OFFLINE ? 'bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.5)]' : 
